...
const generateHTML = (formData) => {
  const { BuyerData, SellerData, date,Rate,Weight,Bags,Bardan,Item,Payment,Notes,quantity } = formData;
  ...
  return `
    <html>
      ...
      <body>
        ...
        <div class="dynamic-field">
          <p><span class="key">Rate:</span> <span class="value">${Rate}</span></p>
          <p><span class="key">Weight:</span> <span class="value">${Weight}</span> Kg</p>
          <p><span class="key">Bags:</span> <span class="value">${Bags}</span></p>
          <p><span class="key">Quantity:</span> <span class="value">${quantity}</span> Kg</p>
          <p><span class="key">Bardan:</span> <span class="value">${Bardan}</span></p>
          <p><span class="key">Item Type:</span> <span class="value">${Item}</span></p>
          <p><span class="key">Payment:</span> <span class="value">${Payment}</span></p>
          <p><span class="key">Note:</span> <span class="value">${Notes}</span></p>
        </div>
      </div>
...
const updateandsharepdf = async (formState) => {
...
export default updateandsharepdf;